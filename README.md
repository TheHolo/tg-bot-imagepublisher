...
После выбора канала экран показывает число ожидающих и обрабатываемых заданий, ближайшую публикацию, режим `photo`/`document`/`auto`, интервал, активное задание и результат проверки права бота публиковать сообщения.
